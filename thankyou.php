<?php
   ...
   {
      if(empty($_POST['name']) || empty($_POST['mobile']) || empty($_POST['email']) || empty($_POST['month'])
      || empty($_POST['date']) || empty($_POST['year'])  ||  empty($_POST['state']) || !filter_var($_POST['email'],FILTER_VALIDATE_EMAIL))
      {
      ...
      "The details are as follows:<br>Name: $name<br>Phone: $phone<br>Email: $email_address<br>Date of Birth: $month-$date-$year
      <br>State: $state";
